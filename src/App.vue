    ...
    <div class="bg-gray-100 grid lg:grid-cols-2 2xl:grid-cols-5">
      ...
      >
        <div class="xl:max-w-xl">
          ...
          />
          <h1
            class="mt-6 text-2xl font-headline tracking-tight font-semibold text-gray-900 sm:mt-8 sm:text-4xl lg:text-3xl xl:text-4xl"
          >
